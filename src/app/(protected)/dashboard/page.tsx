...
const DashboardPage = () => {
  ...
  const handleLogMealVoice = (input: string) => {
    ...
    // Implement voice logging logic here or pass the input to a similar function as handleLogMealText
  }

  const handleLogMealText = (mealDetails: unknown) => {
    console.log("Meal logged via text:", mealDetails);
    // Since Firestore updates mealHistory via onSnapshot, we don't need to update state here.
    // You can add any additional UI updates or messages if needed.
  }
